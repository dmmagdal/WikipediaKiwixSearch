...
def main() -> None:
	...
	submodule_data_dir = "./WikipediaData"
	if not os.path.exists(submodule_data_dir):
		print(f"Download script `download.py` has not extracted any articles from the downloader.")
		print(f"Follow the README.md for instructions on how to download and extract articles from simple wikipedia.")
		exit(1)
	...
	for idx, file in enumerate(data_files):
		...
		# size of the mappings once ready for "production". It's just
